...
/* Private defines -----------------------------------------------------------*/
#define BMS_CS2_Pin GPIO_PIN_13
...
#define MCU_HEARTBEAT_Pin GPIO_PIN_10
#define MCU_HEARTBEAT_GPIO_Port GPIOB
#define BMS_INT2_Pin GPIO_PIN_12
...
#define MCU_PRE_FB_EXTI_IRQn EXTI15_10_IRQn
#define MCU_AIR_positivo_FB_Pin GPIO_PIN_10
#define MCU_AIR_positivo_FB_GPIO_Port GPIOC
#define MCU_AIR_positivo_FB_EXTI_IRQn EXTI15_10_IRQn
#define MCU_AIR_negativo_FB_Pin GPIO_PIN_11
#define MCU_AIR_negativo_FB_GPIO_Port GPIOC
#define MCU_AIR_negativo_FB_EXTI_IRQn EXTI15_10_IRQn
#define MCU_DISCH_FB_Pin GPIO_PIN_12
#define MCU_DISCH_FB_GPIO_Port GPIOC
#define MCU_DISCH_FB_EXTI_IRQn EXTI15_10_IRQn
#define BMS_INT_Pin GPIO_PIN_4
#define BMS_INT_GPIO_Port GPIOB
#define CHARGER_CAN_RX_Pin GPIO_PIN_5
